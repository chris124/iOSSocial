...
#ifndef iOSSocial_InstagramConstants_h
#define iOSSocial_InstagramConstants_h

// OAuth Params Dictionary Keys
static NSString *const kSMInstagramClientID         = @"clientID";
static NSString *const kSMInstagramClientSecret     = @"clientSecret";
...
static NSString *const kSMInstagramRedirectURI      = @"redirectURI";
// Make this a unique name. Incorporate the name of your app.
// Note: this should perhaps be internalized.
static NSString *const kSMInstagramKeychainItemName = @"keychainItemName";
